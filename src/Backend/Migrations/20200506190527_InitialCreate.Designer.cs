...
namespace backend.Migrations
{
    ...
    [Migration("20200506190527_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Guia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Models.GuiaStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Models.GuiaTipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Models.StatusCheckIn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Models.Guia", b =>
                {
                    b.HasOne("Backend.Models.GuiaStatus", "GuiaStatus")
                        .WithMany()
                        .HasForeignKey("GuiaStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Models.GuiaTipo", "GuiaTipo")
                        .WithMany()
                        .HasForeignKey("GuiaTipoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Models.StatusCheckIn", "StatusCheckIn")
                        .WithMany()
